...
# 📖 [GP Global summit] <a name="about-project"></a>

> Describe your project in 1 or 2 sentences.

**[GP Global summit]** is a HTML, CSS and Javascript project for a conference

## 🛠 Built With <a name="htmm, css and javascript"></a>
...
```sh
  cd my-folder
  https://github.com/Wisdomibu/html-css-js-capstone-project.git
```
...
I would like to acknowledge cindy shin on behance for the design
